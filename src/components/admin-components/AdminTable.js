...
export function AdminTable({ searchValue }) {
      ...
      <table className="table table-lg border-gray-500 border-spacing-y-4">
        ...
        <tbody>
          ...
          {admins
            ...
            .map((admin, index) => (
              <tr className="text-base font-medium text-primaryBlack border-gray-200 h-full w-full">
                <th
                  scope="row"
                  key={index}
                ...
                <td className="border-b p-6">{admin.name}</td>
                <td className="border-b p-6">{admin.password}</td>
                <td className="border-b p-6">
                  <div className="flex gap-x-3 items h-full">
                    <Link
                      to={`/admin/view/admin/${admin.id}`}
                    ...
                    <button>
                      <div onClick={() => deleteAdmin(admin.id)}>
                        <svg
                          width="24"
                          height="24"
                          viewBox="0 0 24 24"
